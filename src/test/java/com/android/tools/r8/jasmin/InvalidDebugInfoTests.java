...
public class InvalidDebugInfoTests extends TestBase {
  ...
  public InvalidDebugInfoTests(TestParameters parameters) {
  ...
  public void invalidInfoBug63412730_onWrite() throws Throwable {
    ...
    testForRuntime(parameters)
        ...
        .inspect(
            inspector -> {
              // Check that D8 strips locals (CF is a javac run, not D8).
              assertEquals(
                  parameters.isCfRuntime(),
                  inspector.clazz(clazz.name).method(method).hasLocalVariableTable());
            });
  }
