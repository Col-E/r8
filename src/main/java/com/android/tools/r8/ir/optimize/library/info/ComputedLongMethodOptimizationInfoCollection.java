...
public class ComputedLongMethodOptimizationInfoCollection
  ...
  public AbstractValue getAbstractReturnValueOrDefault(
    ...
    if (singleTarget.getReference().isIdenticalTo(dexItemFactory.longMembers.valueOf)) {
      ...
      if (operandValue.isSingleNumberValue()) {
        return abstractValueFactory.createBoxedLong(operandValue.asSingleNumberValue().getValue());
      }
    }
