...
public class InterfaceDesugaringSyntheticHelper {
  ...
  DexClassAndMethod ensureStaticAsMethodOfCompanionClassStub(
      DexClassAndMethod method, InterfaceMethodDesugaringEventConsumer eventConsumer) {
    if (method.isProgramMethod()) {
  ...
  ProgramMethod ensureStaticAsMethodOfProgramCompanionClassStub(
      ProgramMethod method, InterfaceMethodDesugaringEventConsumer eventConsumer) {
  ...
  private void ensureCompanionClassInitializesInterface(
      DexProgramClass iface, InterfaceMethodDesugaringEventConsumer eventConsumer) {
    ...
    InterfaceProcessor.ensureCompanionMethod(
        ...
        clinit -> {
          // TODO(b/183998768): Once moved to the R8 enqueuer this should never be null.
