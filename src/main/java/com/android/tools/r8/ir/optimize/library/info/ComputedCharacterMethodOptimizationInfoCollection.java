...
public class ComputedCharacterMethodOptimizationInfoCollection
    extends ComputedMethodOptimizationInfoCollection {

  public ComputedCharacterMethodOptimizationInfoCollection(AppView<?> appView) {
    super(appView);
  }
  ...
  public AbstractValue getAbstractReturnValueOrDefault(
    ...
    if (singleTarget.getReference().isIdenticalTo(dexItemFactory.charMembers.valueOf)) {
      ...
      if (operandValue.isSingleNumberValue()) {
        return abstractValueFactory.createBoxedChar(
