...
public class ComputedByteMethodOptimizationInfoCollection
    extends ComputedMethodOptimizationInfoCollection {

  public ComputedByteMethodOptimizationInfoCollection(AppView<?> appView) {
    super(appView);
  }
  ...
  public AbstractValue getAbstractReturnValueOrDefault(
    ...
    if (singleTarget.getReference().isIdenticalTo(dexItemFactory.byteMembers.valueOf)) {
